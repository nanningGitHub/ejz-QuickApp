...
module.exports = {
  ...
  ".login_box .password_box .password_nub": {
    "width": "100%",
    "fontSize": "28px",
    "_meta": {
      "ruleDef": [
  ...
  ".login_box .login_btn .login_btn_text": {
    "fontSize": "28px",
    "color": "#fefefe",
    "_meta": {
      "ruleDef": [
  ...
  ".login_box .forget_register .forget_text": {
    "fontSize": "24px",
    "color": "#333333",
    "_meta": {
      "ruleDef": [
  ...
  ".login_box .forget_register .register_text": {
    "fontSize": "24px",
    "color": "#333333",
    "_meta": {
      "ruleDef": [
...
exports.default = {
    ...
    intoForget: function intoForget() {
        _system2.default.push({
            uri: '/Forget'
        });
    },
    intoRegister: function intoRegister() {
        _system2.default.push({
            uri: '/Register'
        });
    },
    ...
    login: function login() {
        ...
        if (!RegExphone.test(this.phoneNumber)) {
            ...
            (0, _user.login)(this.phoneNumber, this.password).then(function (data) {
                if (data.code !== 0) {
